...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setText("DocumentoTipo");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jDesktop.add(v).setVisible(true);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        FormDocumentoTipo v = new FormDocumentoTipo();
        DocumentoControladorTipo con = new DocumentoControladorTipo(v);
        jDesktop.add(v).setVisible(true);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        FormDocumento v = new FormDocumento();
        // UsuarioControlador con = new UsuarioControlador(v);
        jDesktop.add(v).setVisible(true);        // TODO add your handling code here:
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        FormProprietario v = new FormProprietario();
        ProprietarioControlador con = new ProprietarioControlador(v);
        jDesktop.add(v).setVisible(true);
